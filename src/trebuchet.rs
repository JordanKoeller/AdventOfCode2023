...
pub fn trebuchet(lines: &str) -> (u32, u32) {
...
mod test {
    ...
    fn sample_1_trebuchet() {
        ...
        println!("With sample 1 {:?}", trebuchet(&input));
    ...
    fn sample_2_trebuchet() {
        ...
        println!("With sample 2 {:?}", trebuchet(&input));
        // assert_eq!(true, false);
    }
    ...
    fn answer() {
        let input =
            fs::read_to_string("inputs/trebuchet_1.txt").expect("Could not read input file");
