...
mod tests {
    ...
    fn cubes_sample_1() {
        let input =
            fs::read_to_string("inputs/cubes_1_sample.txt").expect("Could not read input file");
    ...
    #[test]
    fn cubes() {
        let input = fs::read_to_string("inputs/cubes_1.txt").expect("Could not read input file");
